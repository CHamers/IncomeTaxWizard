...
import { CURR_TAX_YEAR_2DIG, PREV_TAX_YEAR, PA, IL, ILPA } from "../utils/constants";
    ...
    <Wrapper>
      <div className="wrapper">
        ...
        <p>
          ...
          10% on the first £{IL} of income, rising to a rate of 40% on the
        ...
        <table>
          ...
          <tfoot>
            <tr>
              <td colspan="3">
                <em>
                  <strong>Note: </strong> Receipts bass means the amount
                  received in the tax year (i.e. from 6 April to 5 April) and
                  accruals basis means the amounts accrued in the tax year.
                </em>
              </td>
            </tr>
          </tfoot>
        ...
        <ul>
          All UK interest is received gross, apart from:
          <li>
            interest from unquoted UK companies (e.g. loan note interest)
          </li>
          <li>savings income from non-discretionary trusts</li>
          These sources are received net of 20% income tax.
        </ul>
        <p>
          As all taxable income must be included gross in an income tax
          computation, any interest income received net of 20% tax must be
          grossed up 100/80 before inclusion in the income tax computation.
        </p>
        <h4>Pension income</h4>
        <p>
          Pension income is taxed on an accruals basis (not a cash receipts
          basis)
        </p>
        <p>
          All pension income accrued in the tax year is taxable as earned
          income, liable to tax in the normal way. A credit is given in the
          individual's income tax computation for any income tax deducted at
          source by the payer of the pension.
        </p>
        <p>
          State pension income is received gross. Occupational pensions are
          usually paid by the employer net of PAYE. Personal pensions are paid
          net of 20% tax.
        </p>
        <h4>Dividend income</h4>
        <p>
          Dividends from UK companies, unit trusts and open-ended investment
          trusts (OEIT) are received gross. They are treated as dividend income
          in the income tax computation.
        </p>
        <p>
          Dividends from overseas companies may be received net overseas tax, in
          which case thy must be grossed up at the appropriate rate.
        </p>
        <p>
          Dividends from Real Estate Investment Trusts (REIT) are received net
          of 20% tax. The amount received must be grossed up by 100/80. such
          dividends are treated in the same way as property income.
        </p>
        <h3>Deductible interest</h3>
        <p>
          If a loan is taken out to finance expenditure which is wholly and
          exclusively for the purpose of a trade, the interest is treated as a
          trading expense and is an allowable deduction in the trading income
          computation. Similarly, if a loan is taken out to finance expenditure
          which is wholly and exclusively for the purpose of a property
          business, the interest is dealt with according to the property
          business income rules.
        </p>
        <p>
          Interest on loans taken out for other qualifying purposes is
          deductible from total income.
        </p>
        <ul>
          Qualifying purposes are to:
          <li>
            buy an interest in a partnership, employee-controlled company or
            co-operative
          </li>
          <li>
            buy plant or machinery for use in the individual's employment or
            partnership. Interest is allowed for three years and is apportioned
            if there is private use of the asset
          </li>
          <li>
            buy ordinary shares in, or make a loan to, a 'close company'.
            However, the interest is not deductible if relief for the shares is
            claimed under the Enterprise Investment Scheme.
          </li>
          All qualifying loan interest is paid gross.
        </ul>
        <h4>Cap on income tax reliefs</h4>
        <p>
          There is a cap on the amount of reliefs that an individual can deduct
          from their total income. Qualifying interest payments are one of the
          types of relief that is subject to this cap.
        </p>
        <p>
          The cap is the greater of £50,000 or 25% of the individual's adjusted
          total income. Adjusted total income is total income less the gross
          amount of any personal pension contributions.
        </p>
        <p>
          An individual who has more than one type of relief that is subject to
          the cap should carefully consider which of their reliefs to deduct
          first. Certain reliefs, such as loss relief, can be carried forward to
          future years if unrelieved in the current year. Other reliefs, such as
          qualifying interest payments, are lost if unrelieved in the year of
          payment. Qualifying interest relief should therefore be claimed in the
          year of payment if possible.
        </p>
      </div>
    </Wrapper>
  );
